        ...
        <div class="appSection">
          ...
          <div class="app_grid_wrapper">
                    <div class="app 1">
                        ...
                        <a href="https://play.google.com/store/apps/details?id=org.wheelmap.android.online&hl=en_US&gl=US"> Android: Wheelmap</a>
                        </i>
                        <br>
                        <i class="fa-brands fa-apple">
                        <a href="https://apps.apple.com/au/app/wheelmap/id399239476"> Apple: Wheelmap</a>
                        </i>
                    </div>
                    ...
                    <div class="app 2">
                        ...
                        <i class="fa-brands fa-android">
                        <a href="https://play.google.com/store/apps/details?id=com.bemyeyes.bemyeyes&hl=en_US&gl=US"> Android: Be My Eyes</a>
                        </i>
                        <br>
                        <i class="fa-brands fa-apple">
                        <a href="https://apps.apple.com/us/app/be-my-eyes/id905177575"> Apple: Be My Eyes</a>
                        </i>
                    </div>
                    ...
                    <div class="app 3">
                        ...
                        <i class="fa-brands fa-android">
                        <a href="https://play.google.com/store/apps/details?id=voicedream.reader&hl=en_US&gl=US"> Android: Legere Reader AppW</a>
                        </i>
                    </div>
                    ...
                    <div class="app 4">
                        ...
                        <i class="fa-brands fa-android">
                        <a href="https://play.google.com/store/apps/details?id=net.seebs.apps.modus&hl=en_US&gl=US"> Android: Miracle Modus</a>
                        </i>
                        <br>
                        <i class="fa-brands fa-apple">
                        <a href="https://apps.apple.com/us/app/miracle-modus/id555904748"> Apple: Miracle Modus</a>
                        </i>
                    </div>
                    ...
                    <div class="app 5">
                        ...
                        much more. For the premium there is the "Super Boost" for those who like that bass when they are listen to music as well as a sound amplifier and so much more.</p>
                        <i class="fa-brands fa-android">
                        <a href="https://play.google.com/store/apps/details?id=com.it4you.petralex"> Android: Petralex Hearing Aid </a>
                        </i>
                        <br>
                        <i class="fa-brands fa-apple">
                        <a href="https://apps.apple.com/us/app/petralex-hearing-aid-app/id816133779"> Apple: Petralex Hearing Aid </a>
                        </i>
                    </div>
                    ...
                    <div class="app 6">
                        ...
                        emotions are high and communication can be next to impossible to communicate.</p>
                        <i class="fa-brands fa-android">
                        <a href="https://play.google.com/store/apps/details?id=com.avazapp.international.lite"> Android: Avaz AAC</a>
                        </i>
                        <br>
                        <i class="fa-brands fa-apple">
                        <a href="https://apps.apple.com/us/app/avaz-aac/id909574843"> Apple: Avaz AAC</a>
                        </i>
                    </div>
                ...
                <div class="app 7">
                        ...
                        which is a few more then the other app. So fare 17,000 user have downloaded this app. </p>
                        <i class="fa-brands fa-android">
                        <a href="https://play.google.com/store/apps/details?id=com.novasa.wheelmate"> Android: Wheelmate</a>
                        </i>
                        <br>
                        <i class="fa-brands fa-apple">
                        <a href="https://apps.apple.com/us/app/wheelmate/id515277627"> Apple: Wheelmate</a>
                        </i>
                </div>
                ...
                <div class="app 8">
                        ...
                        <p id="app_Description"> App Description: </p>
                        <p>This app is geared more toward in general child then just child with disabilities but it is great because, as we know, child with autism tend to have difficulties 
                        ...
                        working on waiting skills. This is great idea for those who have kids with and kids without special needs in that both can benefit from it. </p>
                        <br>
                        <i class="fa-brands fa-apple">
                ...
                <div class="app 9">
                        ...
                        therapists and parents and modify the users boards without having to take the device away from the user. There is also tech support attached to the app as well. </p>
                        <i class="fa-brands fa-android">
